		...
		<form method="POST" action="update_profile.php" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?= $row2->user_id ?>">
		 	<div class="form-group row">
		    	...
		    	<div class="col-sm-4">
		      		<input type="text" name="full_name" class="form-control" value="<?= $row2->full_name ?>" required>
		    	</div>

		    	<label class="col-sm-2 col-form-label"><center>Nama Panggilan</center></label>
		    	<div class="col-sm-4">
		      		<input type="text" name="nick_name" class="form-control" value="<?= $row2->nick_name ?>" required>
		    	</div>
		  	</div>
		  	<div class="form-group row">
		  	...
		  	<div class="form-group row">
		    	...
		    	<div class="col-sm-2">
		      		<input type="text" name="role" class="form-control" value="<?= $row2->role_details ?>" readonly>
		    	</div>
		  	</div>
		  	<div class="form-group row">
