...
$query2 = mysqli_query($koneksi,"SELECT * FROM distributor b JOIN barang d ON b.distributor_id = d.distributor_id WHERE d.barang_id = '$id'") or die (mysqli_error($koneksi));
...
<body>
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					<a class="nav-item nav-link active mx-4" href="catalog.php">
						<h5 class="active font-weight-bold">Stok Barang</h5>
					</a>
	...
	<div class="container" style="margin-right: auto;">
		<form method="POST" action="update_barang.php">
			<input type="hidden" name="id" value="<?= $row2->barang_id ?>">
		 	<div class="form-group row">
		  	...
		  	<div class="form-group row">
		    	...
		    	<label class="col-sm-2 col-form-label"><center>Harga Barang</center></label>
		    	<div class="col-sm-2">
